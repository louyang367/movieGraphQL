	...
	return (
		<Layout>
			...
			<SContainer>
                ...
                <h4>Afterthoughts</h4>
                <Sp>Working with Apollo Graphql's server and client libraries has been a pleasant experience. Apollo server's datasource feature works with a REST api seamlessly. There are community datasources for SQL and Mongodb as well.</Sp>
                ...
                <h4>Next step - make better use of what Apollo Client 3 has to offer!</h4>
                <Sp>On the server-side, Apollo Server's datasource feature works with a REST api seamlessly. There are community datasources for SQL and Mongodb as well. However, this site merely scratches the surface of what Apollo Client 3 is capable of. I really need to come up with some graphQL modification use cases to try it out.</Sp>
                <Sp>On its official site, Apollos says "At its core, Apollo Client is a state management library that happens to use GraphQL to interact with a remote server." In other words, in addition to Redux and React Context, we now have a third choice for state management for a React app. Apollo Client 3 does it by providing cache manipulation, local-only fields and reactive variables and neatly integrating it with React hook. This makes Apollo's graphQL library really shine.</Sp>
                <h4>Code repo</h4>
